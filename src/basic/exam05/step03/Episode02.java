...
public class Episode02 {
	...
	// row  개수를 기준으로 배치
	// => row 개수로 컬럼의 개수가 결정
	//f.setLayout(new GridLayout(3,4)); //기본 레이아웃 관리자를 GridLayout으로 교체
	...
	f.setLayout(new FlowLayout(FlowLayout.RIGHT)); //기본 레이아웃 관리자를 FlowLayout으로 교체
