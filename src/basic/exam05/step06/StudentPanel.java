...
public class StudentPanel extends ContentPanel {
	...
	Button btnDelete = new Button("취소");
	Button btnCancel = new Button("삭제");
	...
	public StudentPanel(){
		...
		listView.addItemListener(new ItemListener() {
			...
			public void itemStateChanged(ItemEvent e) {
				Student s = Student.fromCSV(listView.getItem(listView.getSelectedIndex()));
				...
				StudentPanel.this.validate(); //화면을 유효하게 하라.
