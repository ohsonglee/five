	...
	public static void execute() {
		do {
			...
			if ("add".equals(values[0])) {
				StudentScoreControl.executeAdd(values[1]);
			} else if ("list".equals(values[0])) {
				StudentScoreControl.executeList();
			} else if ("delete".equals(values[0])) {
				StudentScoreControl.executeDelete((Integer.parseInt(values[1])));
			} else if ("update".equals(values[0])) {
				StudentScoreControl.executeUpdate((Integer.parseInt(values[1])));
			} else if ("save".equals(values[0])) {
				StudentScoreControl.executeSave();
			} else if ("load".equals(values[0])) {
				StudentScoreControl.executeLoad();
